        ...
        <x-layouts.grid>
            <div class="md:col-span-6  flex flex-col gap-12 md:items-center md:justify-center">
                <div class="flex flex-col gap-4 items-center md:flex-row">
                    <svg id="Calque_2" width="100" height="100" data-name="Calque 2" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <h2 class="h2-section text-center md:text-left">
                        Pattes
                        <span class="md:block">
                            Heureuses
                        </span>
            ...
            <div class="md:col-span-6">
                <picture>
                    ...
                    <source media="(min-width:530px)" srcset="">
                    <source media="(max-width:529px)" srcset="">
                </picture>

                <img src="{{asset('img/800x800/cat-login.jpg')}}" alt="'test'"
                     class="hidden md:min-h-[100vh] md:w-full md:h-auto md:block md:aspect-auto md:object-cover">
            </div>
        </x-layouts.grid>
