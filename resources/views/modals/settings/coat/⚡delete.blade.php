...
<div wire:click="dispatch('close_modal')"
    ...
    <form wire:click.stop class="bg-white flex flex-col gap-4 p-16 rounded-lg" wire:submit="delete()">
        ...
        <div class="mt-6 flex justify-between">
            ...
            <button type="button" wire:click="dispatch('close_modal')" class="cta-primary">Retour</button>
